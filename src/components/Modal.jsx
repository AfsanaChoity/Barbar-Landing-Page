                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-6 ">
                    ...
                    >
                        ...
                        <div className="relative p-6 md:p-10">
                            ...
                            <h2 className="urbanist-medium mb-6 text-[48px] text-center text-[#161A1A]">Welcome To</h2>
                            ...
                            <h3 className="text-center urbanist-extrabold text-[48px]  mt-6 mb-4 text-[#161A1A]">Barber Time</h3>
                        </div>
                    </div>
                </div>
            )}
