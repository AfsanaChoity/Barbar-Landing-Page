    ...
    <section className="">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <article className="relative bg-white border border-gray-200 rounded-[20px] p-6 md:p-8 shadow-sm">
          {/* Avatar (overlapping) */}
          <div className="absolute left-2 lg:left-4 md:top-8">
            <div className="w-12 h-12 lg:w-20 lg:h-20 rounded-full flex items-center justify-center border-2 border-[#c45c33] bg-[#ef9b73] shadow-sm">
              {/* inner circle to mimic the image feel */}
              <div className="w-8 h-8 lg:w-12 lg:h-12 rounded-full bg-[#f2b089]" />
            </div>
          </div>

          {/* content shifted right so avatar doesn't cover text */}
          <div className="ml-10 lg:ml-20 flex flex-col justify-around gap-4 md:gap-8 xl:gap-12">
            <div className="">
              <h3 className="poppins-semibold text-xl lg:text-[32px]">Rey Anwar</h3>
              <span className="poppins-light lg:text-xl">Founder</span>
            </div>

            <p className=" poppins-extralight text-sm lg:text-[24px] text-justify ">
            ...
            <div className=" flex items-stretch gap-4 ">
              ...
              <blockquote className="poppins-extralight text-xs lg:text-[18px] xl:text-[20px] text-justify">
        ...
        {/* Card 2 */}
         <article className="relative bg-white border border-gray-200 rounded-[20px] p-6 md:p-8 shadow-sm">
          ...
          <div className="ml-10 lg:ml-20 flex flex-col justify-around gap-4 md:gap-8 xl:gap-12">
            <div className="">
              <h3 className="poppins-semibold text-xl lg:text-[32px]">Ahmed Anwar</h3>
              <span className="poppins-light lg:text-xl">Co-Founder</span>
            </div>
      ...
      <div className="mt-10">
        <div className="bg-white border border-gray-200 rounded-xl p-6 md:p-8 shadow-sm flex items-start gap-6">
          ...
          <div className="w-full text-center">
            <h4 className="poppins-bold text-xl lg:text-[32px] mb-2">Joint Quote :</h4>
            <div className="flex gap-2 justify-center">
              <div className="w-1  rounded bg-[#c45c33] " />
              <p className="poppins-extralight text-xs lg:text-[16px] xl:text-[24px] text-justify">
